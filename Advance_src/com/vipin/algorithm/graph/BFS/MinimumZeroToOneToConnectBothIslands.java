...
public class MinimumZeroToOneToConnectBothIslands {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		int grid[][] = { { 1, 0}, {0, 1} };
		MinimumZeroToOneToConnectBothIslands m = new MinimumZeroToOneToConnectBothIslands();
		System.out.println(m.shortestBridge(grid));
