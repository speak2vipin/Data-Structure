...
public class NoOfGroupsWithDifferentKindOfAnagrams {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		String s [] =  {"tars","rats","arts","star"};
		NoOfGroupsWithDifferentKindOfAnagrams n = new NoOfGroupsWithDifferentKindOfAnagrams();
		System.out.println(n.numSimilarGroups(s));
